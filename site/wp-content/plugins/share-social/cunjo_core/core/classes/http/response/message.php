<?php
/**
 * WordPress Fuel - HTTP Response Messages Class
 * 
 * @twitter     http://twitter.com/#!/wordpressfuel
 */
class clsHttp_Response_Message
{
    /**
     ...
     *
     * In most cases, you would use clsHttpResponse::fromString to parse an HTTP
     * response string and create a new clsHttpResponse object.
     *
    ...
    public function __construct($code, array $headers, $body = null, $version = '1.1', $message = null)
    {
        ...
        if (self::responseCodeAsText($code) === null) {
            throw new expHttp("{$code} is not a valid HTTP response code");
        }
        ...
        foreach ($headers as $name => $value) {
            if (is_int($name)) {
                ...
                if (count($header) != 2) {
                    ...
                    throw new expHttp("'{$value}' is not a valid HTTP header");
                }
        ...
        if (! preg_match('|^\d\.\d$|', $version)) {
            throw new expHttp("Invalid HTTP response version: $version");
        }
    ...
    public static function decodeChunkedBody($body)
    {
        ...
        while (trim($body)) {
            if (! preg_match("/^([\da-fA-F]+)[^\r\n]*\r\n/sm", $body, $m)) {
                ...
                throw new expHttp("Error parsing body - doesn't seem to be a chunked message");
            }
    ...
    /**
     * Create a new clsHttpResponse object from a string
     *
     * @param string $response_str
     * @return clsHttpResponse
     */
    public static function fromString($response_str)
    {
        ...
        return new clsHttp_Response_Message($code, $headers, $body, $version, $message);
    }
}
