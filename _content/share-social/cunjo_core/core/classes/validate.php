<?php 
class clsValidate extends ArrayObject 
{
	...
	{
		return (clsUTF8::strlen($value) >= $length);
	}
	...
	public static function alpha($str, $utf8 = FALSE)
	{
		...
		if ($utf8 === TRUE)
		{
			return (bool) preg_match('/^\pL++$/uD', clsHTML::hed($str));
		}
		else
		{
			return ctype_alpha(clsHTML::hed($str));
		}
	}
	...
	public static function alpha_dash($str, $utf8 = FALSE)
	{
		...
		return (bool) preg_match($regex, clsHTML::hed($str));
	}
	 ...
	 * @return  boolean
	 */
	public static function alpha_space($str, $utf8 = true)
	{
		if ($utf8 == true)
		{
			$regex = '/^[-\pL\pN ]++$/uD';
		...
		return preg_match($regex, clsHTML::hed($str));
	}
	...
	public static function color($str)
	{
        ...
        * @param mixed $max
        */
         public static function username($username,$min=2,$max=20)
         {
            return (bool) preg_match('/^[a-z\d_.]{'.$min.','.$max.'}$/i', clsHTML::hed($username));
         }
	...
	public function as_array()
	{
        ...
        public static function is_image($mime_type)
        {
            ...
            return in_array($mime_type,$allowed);
        }
