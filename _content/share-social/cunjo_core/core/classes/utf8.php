...
class clsUTF8 
{
	 ...
	 *
	 *     clsUTF8::clean($_GET); // Clean GET data
	 *
	 ...
	 * @return  mixed
	 * @uses    clsUTF8::strip_ascii_ctrl
	 * @uses    clsUTF8::is_ascii
	 */
	 ...
	 *
	 *     $str = clsUTF8::strip_ascii_ctrl($str);
	 *
	 ...
	 *
	 *     $str = clsUTF8::strip_non_ascii($str);
	 *
	 * @param   string  string to clean
	 * @return  string
	 */
	 ...
	 *
	 *     $ascii = clsUTF8::transliterate_to_ascii($utf8);
	 *
	...
	public static function transliterate_to_ascii($str, $case = 0)
	{
		...
		{
			require CORE_PATH.'utf8'.DIRECTORY_SEPARATOR.__FUNCTION__.EXT;
	 ...
	 *
	 *     $length = clsUTF8::strlen($str);
	 *
	 * @param   string   string being measured for length
	 * @return  integer
	 * @uses    clsUTF8::$server_utf8
	 */
	public static function strlen($str)
	{
		if (clsUTF8::$server_utf8)
			return mb_strlen($str, WPFuel::$charset);
	 ...
	 *
	 *     $position = clsUTF8::strpos($str, $search);
	 *
	...
	{
		if (clsUTF8::$server_utf8)
			return mb_strpos($str, $search, $offset, WPFuel::$charset);
	 ...
	 *
	 *     $position = clsUTF8::strrpos($str, $search);
	 *
	 * @author  Harry Fuecks <hfuecks@gmail.com>
	 * @param   string   haystack
	 * @param   string   needle
	...
	{
		if (clsUTF8::$server_utf8)
			return mb_strrpos($str, $search, $offset, WPFuel::$charset);
	...
	public static function substr($str, $offset, $length = NULL)
	{
		if (clsUTF8::$server_utf8)
			return ($length === NULL)
				? mb_substr($str, $offset, mb_strlen($str), WPFuel::$charset)
				: mb_substr($str, $offset, $length, WPFuel::$charset);
	 ...
	 *
	 *     $str = clsUTF8::substr_replace($str, $replacement, $offset);
	 *
	 * @author  Harry Fuecks <hfuecks@gmail.com>
	 * @param   string   input string
	...
	{
		if (clsUTF8::$server_utf8)
			return mb_strtolower($str, WPFuel::$charset);
	...
	{
		if (clsUTF8::$server_utf8)
			return mb_strtoupper($str, WPFuel::$charset);
	 ...
	 *
	 *     $compare = clsUTF8::strcasecmp($str1, $str2);
	 *
	 * @author  Harry Fuecks <hfuecks@gmail.com>
	 ...
	 *
	 *     $found = clsUTF8::stristr($str, $search);
	 *
	 * @author Harry Fuecks <hfuecks@gmail.com>
	 * @param   string  input string
	 * @param   string  needle
	 ...
	 *
	 *     $found = clsUTF8::strcspn($str, $mask);
	 *
	 * @author  Harry Fuecks <hfuecks@gmail.com>
	 * @param   string   input string
	 * @param   string   mask for search
	 ...
	 *
	 *     $str = clsUTF8::str_pad($str, $length);
	 *
	 * @author  Harry Fuecks <hfuecks@gmail.com>
	 * @param   string   input string
...
if (clsUTF8::$server_utf8 === NULL)
{
    // Determine if this server supports UTF-8 natively
    clsUTF8::$server_utf8 = extension_loaded('mbstring');
}
