...
<div id="bottom_tab_social_channels" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
...
<div id="bottom_tab_bar_layout_design" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
		...
		<div class="row-fluid">
        	...
        	<div class="span6">
            	...
            	<div class="control-group" id="bgcolor-group">
                    ...
                    <div class="input-append">
                        ...
                        <input type="text" id="bgcolor-bottom_tab" name="options[bgcolor]" value="<?php echo $bar_layout_design['bgcolor']; ?>" class="span7"/>
            ...
            <div class="span6">
            	...
            	<div class="control-group" id="textcolor-group">
                    ...
                    <div class="input-append">
                        ...
                        <input type="text" id="textcolor-bottom_tab" name="options[textcolor]" value="<?php echo $bar_layout_design['textcolor']; ?>" class="span7"/>
            ...
            <div class="span12">
            	...
            	<div class="control-group" id="width-group">
                    ...
                    <div class="slider-bar-width-bottom_tab row-fluid">

                        <div class="span3">

                            <input type="text" class="amount span8" name="options[width]" id="width-bottom_tab"/>
...
<div id="bottom_tab_call_to_action" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
    ...
    <form class="form-horizontal" id="call-to-action-bottom_tab" novalidate="novalidate" title="<?php echo $call_to_action['settings_category']; ?>">
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
				...
				<div class="control-group span11" id="activatelink-group-bottom_tab">
                ...
                <div class="control-group" id="messagebtncolor-group-bottom_tab" <?php echo $link_settings; ?>>

					<h5>Button background color</h5>

                    <div class="input-append">

                        <input type="text" id="messagebtncolor-bottom_tab" name="options[messagebtncolor]" value="<?php echo $call_to_action['messagebtncolor']; ?>" class="span7"/>
            ...
            <div class="span6">
                ...
                <div class="control-group" id="messagebtn-group-bottom_tab" <?php echo $link_settings; ?>>
                ...
                <div class="control-group" id="messagebtntext-group-bottom_tab" <?php echo $link_settings; ?>>

					<h5 style="margin-top: 1px;">Button text color</h5>

                    <div class="input-append">

                        <input type="text" id="messagebtntext-bottom_tab" name="options[messagebtntext]" value="<?php echo $call_to_action['messagebtntext']; ?>" class="span7"/>
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
            	...
            	<div class="control-group" id="messagelink-group-bottom_tab" <?php echo $link_settings; ?>>
                    ...
                    <div class="input-prepend span12">
                        ...
                        <input type="text" id="messagelink-bottom_tab" name="options[messagelink]" value="<?php echo $call_to_action['messagelink']; ?>" class="span11"/>
...
<div id="bottom_tab_visibility_settings" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
...
<div id="preview_bottom_tab" class="modal hide fade in widget-preview-modal" tabindex="-1" role="dialog" wp_address="<?php echo get_site_url(); ?>/?cunjo=bottom_tab" aria-hidden="true" style="width: 1150px; margin-left: -575px;top:50%;">
