...
<div id="bottom_elegant_tab_social_channels" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
...
<div id="bottom_elegant_tab_bar_layout_design" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
        	...
        	<div class="span6">
            	...
            	<div class="control-group" id="bgcolor-group">
                    ...
                    <div class="input-append">
                        ...
                        <input type="text" id="bgcolor-bottom_elegant_tab" name="options[bgcolor]" value="<?php echo $bar_layout_design['bgcolor']; ?>" class="span7"/>
            ...
            <div class="span6">
            	...
            	<div class="control-group" id="textcolor-group">
                    ...
                    <div class="input-append">
                        ...
                        <input type="text" id="textcolor-bottom_elegant_tab" name="options[textcolor]" value="<?php echo $bar_layout_design['textcolor']; ?>" class="span7"/>
...
<div id="bottom_elegant_tab_visibility_settings" class="modal hide fade in widget-settings" tabindex="-1" role="dialog" aria-labelledby="registerShareLabel" aria-hidden="true">
...
<div id="preview_bottom_elegant_tab" class="modal hide fade in widget-preview-modal" tabindex="-1" role="dialog" wp_address="<?php echo get_site_url(); ?>/?cunjo=bottom_elegant_tab" aria-hidden="true" style="width: 1150px; margin-left: -575px;top:50%;">
