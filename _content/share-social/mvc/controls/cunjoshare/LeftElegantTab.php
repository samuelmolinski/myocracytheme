...
define('_DEBUG_LEFT_ELEGANT', FALSE);



class cunjoshare_LeftElegantTab_controller extends absController

{
    ...
    private $layout = "left_elegant_tab";
