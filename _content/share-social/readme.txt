...
Cunjo's !Share Social Plugin is a free, pretty, flexible and mobile ready Social Share Plugin with powerful social analytics. Way Better than most famous similar providers.
...
With !Share plugin by Cunjo you can design your own Social Floating Bar and/or Attention Grabber Bar. This plugin also include inline share buttons that can be placed above or under your blog content. And you can download and install addons with extra widgets. 

Major new features in !Share 2.0 include:
...
PS: You'll need a FREE !Share ID to use it. Once you generate the ID from your !Share General Settings, check your email and copy the share ID from the cunjo email received. Paste the code in the General Settings form and save.
...
3. Click on General Settings under the plugin '!Share by Cunjo' main tab in your wordpress menu
4. Enter your !Share ID on the right hand side  field or the form. If you do not have a !Share ID just generate one by submitting the popup register form. You will receive an email with your new ID.
5. Design & Activate the widgets you want.

== Frequently Asked Questions ==

= I already have a !Share ID from cunjo.com/share, can I use that one? =

Yes. If you previously generated a !Share ID from our website you can use it on your plugin. Insert the id in the General Settings form after installation and the system will approve it.
...
Yes. With the !Share plugin you can use both share widget styles.
